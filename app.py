...
user_input = st.sidebar.text_input("Username", value="", max_chars=20)
...
if user_input == USERNAME and password_input == PASSWORD:
    ...
    if ids_to_search:
        ...
        if valid_ids:
            ...
            st.dataframe(filtered_df, height=400, width=1400)  # Shorter height & Wider width
    ...
    st.stop()  # Stops the app unless login is correct
